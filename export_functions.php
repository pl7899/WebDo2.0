...
$closingText = "</body> </html>";
	...
	if($weekValue == "0" || $weekValue == "1" || $weekValue == "t" || $weekValue == "T")
	{
		...
		fwrite($myfile, "document.getElementById('weekInformation').innerHTML = \" " . "week : " . date("W", strtotime($nextDay)) . " , " . date("M dS", strtotime($nextDay)) . " - " . date("dS", strtotime($nextDay . "+ 7 days")) . " \" \n");
